...
cpdefine("inline:com-chilipeppr-widget-super-touchplate", ["chilipeppr_ready", 'Three'], function() {
  return {
    ...
    initUI: function()  {
      // setup run buttons
      $('#com-chilipeppr-widget-super-touchplate #Zplaterun').click(this.onRun.bind(this, "z"));
      $('#com-chilipeppr-widget-super-touchplate #Xplaterun').click(this.onRun.bind(this, "x"));
      $('#com-chilipeppr-widget-super-touchplate #Yplaterun').click(this.onRun.bind(this, "y"));
      //Tabs
      ...
      // Expanded view
      $("#toExpanded").click(this.transferViews.bind(this));
      $("#largeDisplayModal").on('hide.bs.modal', this.transferViews.bind(this));
