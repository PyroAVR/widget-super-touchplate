    ...
    initUI: function()  {
      ...
      $('#com-chilipeppr-widget-super-touchplate .unit-sel').change(function() {
        ...
        if (unitSystem == "G20") {
          ...
          currPlateDepth  = $('#com-chilipeppr-widget-super-touchplate .depthplate').val();
          ...
          newPlateDepth   = currPlateDepth  / 25.4;
          ...
          $('#com-chilipeppr-widget-super-touchplate .depthplate').val(newPlateDepth);
