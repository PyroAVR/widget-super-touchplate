  ...
  return {
    ...
    onAfterProbeDone: function(probeData) {
      ...
      if (this.runningAxis == "x") {
        ...
        var gcode = "";
        if(this.coordOffsetNo == 0) {
          gcode = "G28.3 X" + br + plateWidth + "\n";
        }
        else if (this.coordOffsetNo == 10) { //Allowing G92
          var gcode = "G92 X" + br + plateWidth + "\n";
        }
        else {
          var gcode = "G10 L20 P" + this.coordOffsetNo + " X" + br + plateWidth + "\n";
        }
        var id = "tp" + this.gcodeCtr++;
        chilipeppr.publish("/com-chilipeppr-widget-serialport/jsonSend", {
          Id: id,
      ...
      if (this.runningAxis == "y") {
        ...
        var gcode = "";
        if(this.coordOffsetNo == 0) {
          gcode = "G28.3 Y" + br + plateLength + "\n";
        }
        else if (this.coordOffsetNo == 10) { //Allowing G92
          var gcode = "G92 Y" + br + plateLength +  "\n";
        }
        else {
          var gcode = "G10 L20 P" + this.coordOffsetNo + " Y" + br + plateLength + "\n";
        }
        var id = "tp" + this.gcodeCtr++;
        chilipeppr.publish("/com-chilipeppr-widget-serialport/jsonSend", {
          Id: id,
